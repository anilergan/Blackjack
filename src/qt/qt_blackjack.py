...
"}")
        ...
        self.scrollArea_agent_list_WidgetContents.setGeometry(QRect(0, 0, 50, 30))
...
"")
        ...
        self.spinBox_achieved_budget.setMinimum(100)
        self.spinBox_achieved_budget.setMaximum(2000)
